...
public class PolymorphismPractice2 {
    ...
    public static void main(String[] args) {
        ...
        Employee[] employees = {
                ...
                new Tester("George",28,'M',3,"SDET",110000),
                new Developer("Cristina",23,'F',4,"Software Developer",128000),
                new Tester("Cihad",30,'M',5,"SDET",110000),
                new Developer("Gulistan",26,'F',6,"Web Developer",128000),
                new Tester("Yuliya",28,'F',7,"QE",110000),
                new Developer("Cassendra",29,'F',8,"Front-end Developer",128000),
        ...
        Tester testerWithMxSalary = testers.get(0);
        Developer developerWithMaxSalary = developers.get(0);

        for (Tester each : testers) {
            if(each.getSalary() > testerWithMxSalary.getSalary()){
                testerWithMxSalary = each;
            }
