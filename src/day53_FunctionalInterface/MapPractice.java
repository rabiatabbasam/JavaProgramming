...
public class MapPractice {
    ...
    public static void main(String[] args) {
        ...
        unit1.put("Print statement", 6.0);
        unit1.put("Escape Sequence", 3.0);
        unit1.put("Primitives", 6.0);
        unit1.put("Operator", 9.0);
        ...
        //1. Display each Java topics and its hours on the console
